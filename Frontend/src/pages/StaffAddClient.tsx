...
const StaffAddClient = () => {
  return (
    <div className="w-full h-full flex flex-col">
      ...
      {/* BREADCRUMB HEADER */}
      <div className="bg-black text-white px-8 py-2 mb-8 -mt-8 -mx-8 flex items-center gap-2">
        <Link to="/staff-dashboard" className="hover:text-[#FE5C00]">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
            </svg>
        </Link>
        <span className="text-sm font-medium">Home / Client Details</span>
      </div>
